...
namespace ProblemDetails.Tests
{
    public class ProblemDetailsMiddlewareTests
    {
        ...
        [InlineData("application/problem+xml", "application/json", "application/problem+xml")]
        [InlineData("application/problem+xml", "application/xml", "application/problem+xml")]
        [InlineData("application/problem+xml", "application/csv", "application/problem+xml")]
